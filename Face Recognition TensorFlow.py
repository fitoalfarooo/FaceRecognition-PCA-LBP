...
de detectar los rostros de nuestros compañeros del curso de Reconocimiento de Patrones
'''

import tensorflow as tf, time, math, os, DataTF
...
X, Y= DataTF.LoadTrainingData(training_dir, (imageWidth, imageHeight))
DataTF.TrainingData = X
DataTF.TrainingLables = Y

XT, YT, NamesT, _, Paths = DataTF.LoadTestingData(testing_dir, (imageWidth, imageHeight))
DataTF.TestingData = XT
DataTF.TestingLables = YT
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1, NEpochs+1):
            ...
            avg_acc = 0.0
            for i in range(rang):
                epochX, epochY = DataTF.nextBatch(BatchSize)
